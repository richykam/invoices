...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { company_name: @quotation.company_name, itemid: @quotation.itemid, price: @quotation.price }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { company_name: @quotation.company_name, itemid: @quotation.itemid, price: @quotation.price }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
